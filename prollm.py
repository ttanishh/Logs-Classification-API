...
API_GROQ = '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'

load_dotenv()

# Pass the API key directly to the Groq client
groq = Groq(api_key=API_GROQ)
...
def classify_with_llm(log_msg):
    ...
    if match:
        category = match.group(1).strip()  # Added .strip() to remove whitespace
